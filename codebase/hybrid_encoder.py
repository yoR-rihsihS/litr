...
class HybridEncoder(nn.Module):
    def __init__(self, in_channels, feat_strides, hidden_dim, nhead, dim_feedforward, dropout,
                 use_encoder_idx, num_encoder_layers, eval_spatial_size=None):
        super().__init__()
        ...
        for _ in range(len(in_channels) - 1, 0, -1):
            ...
            self.fpn_blocks.append(
                CSPRepLayer(hidden_dim * 2, hidden_dim, act="silu")
            )
    ...
    def _reset_parameters(self):
        if self.eval_spatial_size:
            for idx in self.use_encoder_idx:
                ...
                pos_embed = self.build_2d_sincos_position_embedding(self.eval_spatial_size[1] // stride, self.eval_spatial_size[0] // stride, self.hidden_dim)
